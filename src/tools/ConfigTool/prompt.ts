...
export const DESCRIPTION = 'Get or set CORTEX configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set CORTEX configuration settings.

  View or change CORTEX settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
