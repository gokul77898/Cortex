 ...
 * clone/push in anthropic.com/code works immediately after this succeeds.
 */
...
> {
  ...
  const headers = {
    ...
    'cortex-beta': CCR_BYOC_BETA_HEADER,
...
/** Returns true when the user has valid CORTEX OAuth credentials. */
