...
/**
 * Loads markdown files from .cortex/output-styles directories throughout the project
 * and from ~/.cortex/output-styles directory and converts them to output styles.
 *
 ...
 *
 * Structure:
 * - Project .cortex/output-styles/*.md -> project styles
 * - User ~/.cortex/output-styles/*.md -> user styles (overridden by project styles)
 *
