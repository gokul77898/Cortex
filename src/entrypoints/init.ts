...
import { preconnectCORTEXApi } from '../utils/apiPreconnect.js'
...
export const init = memoize(async (): Promise<void> => {
  ...
  try {
    ...
    // Preconnect to the CORTEX API — overlap TCP+TLS handshake
    ...
    // CORTEX_REMOTE + GrowthBook; fail-open on any error. Lazy import so
