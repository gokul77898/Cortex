 ...
 *
 * Example: `availability: ['cortex-ai', 'console']` shows the command to
 * anthropic.com subscribers and direct Console API key users (api.anthropic.com),
 * but hides it from Bedrock/Vertex/Foundry users and custom base URL users.
 */
export type CommandAvailability =
  // anthropic.com OAuth subscriber (Pro/Max/Team/Enterprise via anthropic.com)
  | 'cortex-ai'
  // Console API key user (direct api.anthropic.com, not via anthropic.com OAuth)
  | 'console'
