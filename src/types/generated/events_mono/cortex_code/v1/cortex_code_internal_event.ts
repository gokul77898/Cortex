...
export interface EnvironmentMetadata {
  ...
  is_cortex_code_action?: boolean | undefined
  is_cortex_ai_auth?: boolean | undefined
  ...
  is_cortex_code_remote?: boolean | undefined
  remote_environment_type?: string | undefined
  cortex_code_container_id?: string | undefined
  cortex_code_remote_session_id?: string | undefined
...
export interface CORTEXCodeInternalEvent {
...
export const CORTEXCodeInternalEvent = {
  fromJSON(object: any): CORTEXCodeInternalEvent {
    return object ?? {}
  },

  toJSON(message: CORTEXCodeInternalEvent): unknown {
    return message ?? {}
  },

  create<I extends CORTEXCodeInternalEvent>(
    base?: I,
  ): CORTEXCodeInternalEvent {
    return base ?? {}
  },

  fromPartial<I extends CORTEXCodeInternalEvent>(
    object: I,
  ): CORTEXCodeInternalEvent {
    return object ?? {}
  },
