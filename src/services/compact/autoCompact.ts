...
import { getMaxOutputTokensForModel } from '../api/cortex.js'
...
export function getEffectiveContextWindowSize(model: string): number {
  ...
  const autoCompactWindow = process.env.CORTEX_AUTO_COMPACT_WINDOW
...
export function calculateTokenWarningState(
  ...
  const blockingLimitOverride = process.env.CORTEX_BLOCKING_LIMIT_OVERRIDE
