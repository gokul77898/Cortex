...
/**
 * Map LSP severity to CORTEX diagnostic severity
 *
 * Maps LSP severity numbers to CORTEX diagnostic severity strings.
...
/**
 * Convert LSP diagnostics to CORTEX diagnostic format
 *
 * Converts LSP PublishDiagnosticsParams to DiagnosticFile[] format
 * used by CORTEX's attachment system.
 */
 ...
 * from all LSP servers and routes them to CORTEX's diagnostic system.
      ...
      serverInstance.onNotification(
        ...
        (params: unknown) => {
          ...
          try {
            ...
            // Convert LSP diagnostics to CORTEX format (can throw on invalid URIs)
