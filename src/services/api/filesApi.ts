 ...
 *
 * This module provides functionality to download and upload files to CORTEX Public Files API.
 * Used by the CORTEX agent to download file attachments at session startup.
 *
...
function getDefaultApiBaseUrl(): string {
  return (
    ...
    process.env.CORTEX_API_BASE_URL ||
...
/**
 * Downloads a single file from the CORTEX Public Files API
 *
...
export async function downloadFile(
  ...
  const headers = {
    ...
    'cortex-version': ANTHROPIC_VERSION,
    'cortex-beta': FILES_API_BETA_HEADER,
  }
