...
export function convertCORTEXMessagesToResponsesInput(
...
export async function performCodexRequest(options: {
  ...
  const input = convertCORTEXMessagesToResponsesInput(
...
export async function* codexStreamToCORTEX(
  response: Response,
  model: string,
...
export function convertCodexResponseToCORTEXMessage(
  data: Record<string, any>,
  model: string,
