...
import type { OverageDisabledReason } from './cortexAiLimits.js'

type SubscriptionType = string

type MockHeaders = {
  'cortex-ratelimit-unified-status'?:
    | 'allowed'
    | 'allowed_warning'
    | 'rejected'
  'cortex-ratelimit-unified-reset'?: string
  ...
  'cortex-ratelimit-unified-overage-status'?:
    ...
    | 'allowed_warning'
    | 'rejected'
  'cortex-ratelimit-unified-overage-reset'?: string
  'cortex-ratelimit-unified-overage-disabled-reason'?: OverageDisabledReason
  'cortex-ratelimit-unified-fallback'?: 'available'
  'cortex-ratelimit-unified-fallback-percentage'?: string
  'retry-after'?: string
  'cortex-ratelimit-unified-5h-utilization'?: string
  'cortex-ratelimit-unified-5h-reset'?: string
  'cortex-ratelimit-unified-5h-surpassed-threshold'?: string
  'cortex-ratelimit-unified-7d-utilization'?: string
  'cortex-ratelimit-unified-7d-reset'?: string
  'cortex-ratelimit-unified-7d-surpassed-threshold'?: string
  'cortex-ratelimit-unified-overage-utilization'?: string
  'cortex-ratelimit-unified-overage-surpassed-threshold'?: string
}
