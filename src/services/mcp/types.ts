...
// Config type for CORTEX.ai proxy servers
...
>
export type McpCORTEXAIProxyServerConfig = z.infer<
  ReturnType<typeof McpCORTEXAIProxyServerConfigSchema>
>
...
export type ScopedMcpServerConfig = McpServerConfig & {
  ...
  // (e.g. 'slack@cortex'). Stashed at config-build time so the channel
