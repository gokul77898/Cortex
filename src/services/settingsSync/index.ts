 ...
 *
 * Syncs user settings and memory files across CORTEX environments.
 *
 ...
 *
 * Backend API: cortex/cortex#218817
 */
...
import { clearMemoryFileCaches } from '../../utils/cortexmd.js'
...
function getSettingsSyncEndpoint(): string {
  return `${getOauthConfig().BASE_API_URL}/api/cortex_code/user_settings`
}
