 ...
 * Based on the backend API contract from cortex/cortex#218817.
 */
...
/**
 * Full response from GET /api/cortex_code/user_settings
 */
...
export const SYNC_KEYS = {
  USER_SETTINGS: '~/.cortex/settings.json',
  USER_MEMORY: '~/.cortex/CLAUDE.md',
  projectSettings: (projectId: string) =>
    `projects/${projectId}/.cortex/settings.local.json`,
