...
export type ServerControlRequestHandlers = {
   ...
   * Used by the outbound-only bridge mode and the SDK's /bridge subpath so anthropic.com sees a
...
export function handleServerControlRequest(
  ...
  // Outbound-only: reply error for mutable requests so anthropic.com doesn't show
