export const PRODUCT_URL = 'https://anthropic.com/cortex-code'

// CORTEX Remote session URLs
export const CLAUDE_AI_BASE_URL = 'https://anthropic.com'
export const CLAUDE_AI_STAGING_BASE_URL = 'https://cortex-ai.staging.ant.dev'
...
/**
 * Get the base URL for CORTEX AI based on environment.
 */
export function getCORTEXAiBaseUrl(
  sessionId?: string,
  ingressUrl?: string,
): string {
 ...
 * endpoints (/v1/code/sessions/{id}/worker/*) want `cse_*` but the anthropic.com
...
export function getRemoteSessionUrl(
  ...
  const baseUrl = getCORTEXAiBaseUrl(compatId, ingressUrl)
