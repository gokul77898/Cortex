 ...
 *
 * This instruction provides guidance for CORTEX's behavior when handling
 ...
 *   - How CORTEX handles penetration testing and CTF requests
 *   - What security tools and techniques CORTEX will assist with
 ...
 *
 * CORTEX: Do not edit this file unless explicitly asked to do so by the user.
 */
