...
export function PackageManagerAutoUpdater(t0) {
  ...
  const updateCommand = packageManager === "homebrew" ? "brew upgrade cortex-code" : packageManager === "winget" ? "winget upgrade CORTEX.CORTEXCode" : packageManager === "apk" ? "apk upgrade cortex-code" : "your package manager update command";
  let t4;
  if ($[3] !== verbose) {
