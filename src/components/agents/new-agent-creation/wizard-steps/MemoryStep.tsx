...
export function MemoryStep() {
  ...
  if ($[1] !== isUserScope) {
    t1 = isUserScope ? [{
      label: "User scope (~/.cortex/agent-memory/) (Recommended)",
      value: "user"
    }, {
      label: "None (no persistent memory)",
      value: "none"
    }, {
      label: "Project scope (.cortex/agent-memory/)",
      value: "project"
    }, {
      label: "Local scope (.cortex/agent-memory-local/)",
      value: "local"
    }] : [{
      label: "Project scope (.cortex/agent-memory/) (Recommended)",
      value: "project"
    }, {
      label: "None (no persistent memory)",
      value: "none"
    }, {
      label: "User scope (~/.cortex/agent-memory/)",
      value: "user"
    }, {
      label: "Local scope (.cortex/agent-memory-local/)",
      value: "local"
