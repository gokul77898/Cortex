...
// fails when cortex runs remotely inside a VS Code integrated terminal.
...
export function supportsExtendedKeys(): boolean {
  // CORTEX defaults this off because some real terminals render the UI
  ...
  if (process.env.CORTEX_ENABLE_EXTENDED_KEYS !== '1') {
    return false
  }
