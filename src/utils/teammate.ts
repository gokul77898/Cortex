 ...
 *
 * These helpers identify whether this CORTEX instance is running as a
...
export function isPlanModeRequired(): boolean {
  ...
  return isEnvTruthy(process.env.CORTEX_PLAN_MODE_REQUIRED)
}
 ...
 * 2. Either:
 *    - Our CORTEX_AGENT_ID matches the leadAgentId, OR
 *    - We have no CORTEX_AGENT_ID set (backwards compat: the original
