...
import { queryModelWithoutStreaming } from '../../services/api/cortex.js'
...
export async function applySkillImprovement(
  ...
  // Skills live at .cortex/skills/<name>/SKILL.md relative to CWD
  const filePath = join(getCwd(), '.cortex', 'skills', skillName, 'SKILL.md')
