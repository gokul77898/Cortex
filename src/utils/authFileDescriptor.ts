 ...
 * /home/cortex/.cortex/remote/ and will (eventually) write these files too.
 ...
 */
const CCR_TOKEN_DIR = '/home/cortex/.cortex/remote'
 ...
 * access. CCR-gated: outside CCR there's no /home/cortex/ and no reason to
 ...
 * rationale. Env var: CORTEX_OAUTH_TOKEN_FILE_DESCRIPTOR.
 * Well-known file: /home/cortex/.cortex/remote/.oauth_token.
 */
export function getOAuthTokenFromFileDescriptor(): string | null {
  return getCredentialFromFd({
    envVar: 'CORTEX_OAUTH_TOKEN_FILE_DESCRIPTOR',
 ...
 * rationale. Env var: CORTEX_API_KEY_FILE_DESCRIPTOR.
 * Well-known file: /home/cortex/.cortex/remote/.api_key.
 */
export function getApiKeyFromFileDescriptor(): string | null {
  return getCredentialFromFd({
    envVar: 'CORTEX_API_KEY_FILE_DESCRIPTOR',
