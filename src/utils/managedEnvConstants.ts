 ...
 *
 * When CORTEX_PROVIDER_MANAGED_BY_HOST is truthy in the spawn env, these
 * are stripped from settings-sourced env so the host's routing config isn't
 * overridden by a user's ~/.cortex/settings.json — e.g. a Bedrock setup for
...
const PROVIDER_MANAGED_ENV_VARS = new Set([
  ...
  'CORTEX_PROVIDER_MANAGED_BY_HOST',
  // Provider selection
  'CORTEX_USE_BEDROCK',
  'CORTEX_USE_VERTEX',
  'CORTEX_USE_FOUNDRY',
  ...
  'CORTEX_SKIP_BEDROCK_AUTH',
  'CORTEX_SKIP_VERTEX_AUTH',
  'CORTEX_SKIP_FOUNDRY_AUTH',
 ...
 * These are CORTEX specific settings that don't pose security risks.
 *
...
export const SAFE_ENV_VARS = new Set([
  ...
  'CORTEX_API_KEY_HELPER_TTL_MS',
  'CORTEX_DISABLE_EXPERIMENTAL_BETAS',
  'CORTEX_DISABLE_NONESSENTIAL_TRAFFIC',
  'CORTEX_DISABLE_TERMINAL_TITLE',
  'CORTEX_ENABLE_TELEMETRY',
  'CORTEX_EXPERIMENTAL_AGENT_TEAMS',
  'CORTEX_IDE_SKIP_AUTO_INSTALL',
