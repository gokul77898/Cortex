...
import { isCORTEXSettingsPath } from '../permissions/filesystem.js'
...
export function validateInputForSettingsFileEdit(
  ...
  // Only validate CORTEX settings files
