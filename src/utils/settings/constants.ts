...
/**
 * The JSON Schema URL for CORTEX settings
 * You can edit the contents at https://github.com/SchemaStore/schemastore/blob/master/src/schemas/json/cortex-code-settings.json
 */
export const CORTEX_SETTINGS_SCHEMA_URL =
  'https://json.schemastore.org/cortex-code-settings.json'
