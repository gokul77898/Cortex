  ...
  if (shouldAllowManagedHooksOnly()) {
    ...
    try {
      ...
      if (
        ...
        userGuidance =
          'This appears to be a permissions issue. Check file permissions on ~/.cortex/plugins/'
      } else if (
        ...
        userGuidance =
          'This appears to be a configuration issue. Check your plugin settings in .cortex/settings.json'
      } else {
        userGuidance =
      ...
      // from .cortex/settings.json (loaded via captureHooksConfigSnapshot) will still work
    }
  }
