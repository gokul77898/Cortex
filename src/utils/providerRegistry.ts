...
const PROVIDER_REGISTRY: ProviderEntry[] = [
  ...
  // ===== Local Providers =====
  {
    ...
    defaultModel: 'RefinedNeuro/vibethinker-3b-hermes:Q4_K_M',
    requiresApiKey: false,
    apiKeyHint: 'Pull model: ollama pull RefinedNeuro/vibethinker-3b-hermes:Q4_K_M',
    docsUrl: 'https://ollama.ai',
    knownModels: [
      'RefinedNeuro/vibethinker-3b-hermes:Q4_K_M',
    ],
    isOpenAICompatible: true,
  },
  {
