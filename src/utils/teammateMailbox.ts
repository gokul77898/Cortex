 ...
 *
 * Each teammate has an inbox file at .cortex/teams/{team_name}/inboxes/{agent_name}.json
 ...
 * Structure: ~/.cortex/teams/{team_name}/inboxes/{agent_name}.json
 */
 ...
 * @param teamName - Optional team name (defaults to CORTEX_TEAM_NAME env var or 'default')
 */
...
export type SandboxPermissionRequestMessage = {
  ...
  requestId: string
  /** Worker's CORTEX_AGENT_ID */
  workerId: string
  /** Worker's CORTEX_AGENT_NAME */
  workerName: string
  /** Worker's CORTEX_AGENT_COLOR */
  workerColor?: string
 ...
 * @param teamName - Optional team name (defaults to CORTEX_TEAM_NAME env var)
