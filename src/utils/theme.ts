...
export type Theme = {
  ...
  bashBorder: string
  cortex: string
  cortexShimmer: string // Lighter version of cortex color for shimmer effect
  cortexBlue_FOR_SYSTEM_SPINNER: string
  cortexBlueShimmer_FOR_SYSTEM_SPINNER: string
  permission: string
...
const lightTheme: Theme = {
  ...
  cortex: 'rgb(215,119,87)', // CORTEX orange
  cortexShimmer: 'rgb(245,149,117)', // Lighter cortex orange for shimmer effect
  cortexBlue_FOR_SYSTEM_SPINNER: 'rgb(87,105,247)', // Medium blue for system spinner
  cortexBlueShimmer_FOR_SYSTEM_SPINNER: 'rgb(117,135,255)', // Lighter blue for system spinner shimmer
  ...
  briefLabelCORTEX: 'rgb(215,119,87)', // Brand orange
...
const lightAnsiTheme: Theme = {
  ...
  cortex: 'ansi:redBright',
  cortexShimmer: 'ansi:yellowBright',
  cortexBlue_FOR_SYSTEM_SPINNER: 'ansi:blue',
  cortexBlueShimmer_FOR_SYSTEM_SPINNER: 'ansi:blueBright',
  ...
  briefLabelCORTEX: 'ansi:redBright',
...
const darkAnsiTheme: Theme = {
  ...
  cortex: 'ansi:redBright',
  cortexShimmer: 'ansi:yellowBright',
  cortexBlue_FOR_SYSTEM_SPINNER: 'ansi:blueBright',
  cortexBlueShimmer_FOR_SYSTEM_SPINNER: 'ansi:blueBright',
...
const lightDaltonizedTheme: Theme = {
  ...
  cortex: 'rgb(255,153,51)', // Orange adjusted for deuteranopia
  cortexShimmer: 'rgb(255,183,101)', // Lighter orange for shimmer effect
  cortexBlue_FOR_SYSTEM_SPINNER: 'rgb(51,102,255)', // Bright blue for system spinner
  cortexBlueShimmer_FOR_SYSTEM_SPINNER: 'rgb(101,152,255)', // Lighter bright blue for system spinner shimmer
  ...
  fastModeShimmer: 'rgb(255,150,50)', // Lighter orange for shimmer
  briefLabelYou: 'rgb(37,99,235)', // Blue
  briefLabelCORTEX: 'rgb(255,153,51)', // Orange adjusted for deuteranopia (matches cortex)
  rainbow_red: 'rgb(235,95,87)',
  rainbow_orange: 'rgb(245,139,87)',
  rainbow_yellow: 'rgb(250,195,95)',
  rainbow_green: 'rgb(145,200,130)',
...
const darkTheme: Theme = {
  ...
  cortex: 'rgb(215,119,87)', // CORTEX orange
  cortexShimmer: 'rgb(235,159,127)', // Lighter cortex orange for shimmer effect
  cortexBlue_FOR_SYSTEM_SPINNER: 'rgb(147,165,255)', // Blue for system spinner
  cortexBlueShimmer_FOR_SYSTEM_SPINNER: 'rgb(177,195,255)', // Lighter blue for system spinner shimmer
...
const darkDaltonizedTheme: Theme = {
  ...
  cortex: 'rgb(255,153,51)', // Orange adjusted for deuteranopia
  cortexShimmer: 'rgb(255,183,101)', // Lighter orange for shimmer effect
  cortexBlue_FOR_SYSTEM_SPINNER: 'rgb(153,204,255)', // Light blue for system spinner
  cortexBlueShimmer_FOR_SYSTEM_SPINNER: 'rgb(183,224,255)', // Lighter blue for system spinner shimmer
