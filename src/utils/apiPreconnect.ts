/**
 * Preconnect to the CORTEX API to overlap TCP+TLS handshake with startup.
 *
...
export function preconnectCORTEXApi(): void {
  if (fired) return
  fired = true

  // Third-party providers should not warm a connection to CORTEX.
