 ...
 *
 * Parses `cortex-cli://open` URIs. All parameters are optional:
 ...
 * Examples:
 *   cortex-cli://open
 *   cortex-cli://open?q=hello+world
 *   cortex-cli://open?q=fix+tests&repo=owner/repo
 *   cortex-cli://open?cwd=/path/to/project
 *
...
export const DEEP_LINK_PROTOCOL = 'cortex-cli'
 ...
 * the `cd /d <cwd> && <cortex.exe> --deep-link-origin ... --prefill "<q>"`
...
/**
 * Parse a cortex-cli:// URI into a structured action.
 *
...
/**
 * Build a cortex-cli:// deep link URL.
 */
