...
export async function checkContextWarnings(
  ...
  const [cortexMdWarning, agentWarning, mcpWarning, unreachableRulesWarning] =
    await Promise.all([
      checkCORTEXMdFiles(),
