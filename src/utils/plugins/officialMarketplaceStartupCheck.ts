/**
 * Auto-install logic for the official CORTEX marketplace.
 *
...
export function isOfficialMarketplaceAutoInstallDisabled(): boolean {
  return isEnvTruthy(
    process.env.CORTEX_DISABLE_OFFICIAL_MARKETPLACE_AUTOINSTALL,
  )
}
...
export async function checkAndInstallOfficialMarketplace(): Promise<OfficialMarketplaceCheckResult> {
  ...
  try {
    ...
    // Backend (cortex#317037) publishes a marketplace zip to the same
