/**
 * Constants for the official CORTEX plugins marketplace.
 *
 * The official marketplace is hosted on GitHub and provides first-party
 * plugins developed by CORTEX. This file defines the constants needed
...
/**
 * Source configuration for the official CORTEX plugins marketplace.
 ...
 */
export const OFFICIAL_MARKETPLACE_NAME = 'cortex-plugins-official'
