 ...
 * for UI reason/text only. If re-introduced, serve from downloads.anthropic.com.
 */
 ...
 * @param marketplaceName The marketplace name suffix (e.g. "cortex-plugins-official")
