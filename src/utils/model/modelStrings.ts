...
function getBuiltinModelStrings(provider: APIProvider): ModelStrings {
  // Codex piggybacks on the OpenAI provider transport for CORTEX tier aliases.
...
async function getBedrockModelStrings(): Promise<ModelStrings> {
  ...
  // user's inference profile list (e.g. "cortex-opus-4-6" matches
  // "eu.cortex.cortex-opus-4-6-v1"). Fall back to the hardcoded bedrock ID
 ...
 * model ID (e.g. "cortex-opus-4-6") and map to arbitrary provider-specific
