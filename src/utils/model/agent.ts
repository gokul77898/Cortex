...
export function getAgentModel(
  ...
  if (process.env.CORTEX_SUBAGENT_MODEL) {
    return parseUserSpecifiedModel(process.env.CORTEX_SUBAGENT_MODEL)
  }
  ...
  // region prefix (e.g., "eu.cortex.…"), we preserve it instead of overwriting
