 ...
 *   cortex --provider gemini --model gemini-2.0-flash
 *   cortex --provider ollama --model llama3.2
 *   cortex --provider cortex   (default, no-op)
 */
 ...
 * Sets the required CORTEX_USE_* flag and any provider-specific
