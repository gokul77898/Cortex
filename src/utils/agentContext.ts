 ...
 * variables instead: CORTEX_AGENT_ID, CORTEX_PARENT_SESSION_ID
 *
...
export type SubagentContext = {
  ...
  agentId: string
  /** The team lead's session ID (from CORTEX_PARENT_SESSION_ID env var), undefined for main REPL subagents */
