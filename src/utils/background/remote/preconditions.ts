...
/**
 * Checks if user needs to log in with CORTEX.ai
 * Extracted from getTeleportErrors() in TeleportError.tsx
 * @returns true if login is required, false otherwise
 */
export async function checkNeedsCORTEXAiLogin(): Promise<boolean> {
 ...
 * @param owner The repository owner (e.g., "cortexs")
 * @param repo The repository name (e.g., "cortex-cli-internal")
