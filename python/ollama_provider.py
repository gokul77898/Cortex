...
ollama_provider.py
------------------
Adds native Ollama support to cortex.
Lets CORTEX route requests to any locally-running Ollama model
...
def cortex_to_ollama_messages(messages: list[dict]) -> list[dict]:
    ollama_messages = []
    for msg in messages:
...
async def ollama_chat(
    ...
    ollama_messages = cortex_to_ollama_messages(messages)
    if system:
