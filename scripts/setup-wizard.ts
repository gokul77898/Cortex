...
const PROVIDERS = [
  {
    ...
    models: [
      { id: 'meta/esm2-650m',                               name: 'ESM2 650M                        · protein embeddings' },
      { id: 'stepfun-ai/step-3.7-flash',                    name: 'Step 3.7 Flash                   · MoE reasoning'       },
      { id: 'z-ai/glm-5.1',                                 name: 'GLM 5.1                          · agentic AI'          },
      { id: 'nvidia/nemotron-3-content-safety',             name: 'Nemotron 3 Content Safety        · toxicity detection' },
      { id: 'minimaxai/minimax-m2.7',                       name: 'MiniMax M2.7                     · 230B coding'         },
      { id: 'mistralai/mistral-large-3-675b-instruct-2512', name: 'Mistral Large 3 675B             · MoE VLM flagship'    },
      { id: 'qwen/qwen3-coder-480b-a35b-instruct',          name: 'Qwen3 Coder 480B                 · agentic coding'      },
      { id: 'mistralai/mistral-nemotron',                   name: 'Mistral Nemotron                 · agentic workflows'   },
    ],
  },
  {
    id:      'openai',
