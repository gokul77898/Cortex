/**
 * No-Telemetry Build Plugin for CORTEX
 *
 * Replaces all analytics, telemetry, and phone-home modules with no-op stubs
 * at compile time. Zero runtime cost, zero network calls to CORTEX.
 *
 ...
 *   - BigQuery metrics exporter (api.anthropic.com/api/cortex_code/metrics)
...
export function getLockFilePath() { return '/tmp/cortex-update.lock'; }
...
`,
	...
	// ─── Deleted CORTEX-internal modules ───────────────────────────────
...
`,
	...
	'types/generated/events_mono/cortex_code/v1/cortex_code_internal_event': `
